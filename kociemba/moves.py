...
import array as ar
from kociemba import cubie as cb
from kociemba import enums
from kociemba.defs import N_TWIST, N_FLIP, N_SLICE_SORTED, N_CORNERS, N_UD_EDGES, N_MOVE
...
fname = folder_name / "move_slice_sorted"
if not fname.is_file():
    print("creating " + str(fname) + " table...")
...
fname = folder_name / "move_u_edges"
if not fname.is_file():
    print("creating " + str(fname) + " table...")
...
fname = folder_name / "move_d_edges"
if not fname.is_file():
    print("creating " + str(fname) + " table...")
...
fname = folder_name / "move_ud_edges"
if not fname.is_file():
    print("creating " + str(fname) + " table...")
...
fname = folder_name / "move_corners"
if not fname.is_file():
    print("creating " + str(fname) + " table...")
